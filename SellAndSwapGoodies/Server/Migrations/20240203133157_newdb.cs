    ...
    public partial class newdb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "3781efa7-66dc-47f0-860f-e506d04102e4", 0, 0, "5864c047-a023-437e-9fe9-8bdf613140dd", "admin@localhost.com", false, "Admin", "User", false, null, "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAEPfMxEwkutT0QU67I/N0Q4G56/LFXIQSA9oydZhaX+c54UMtHguB9TXqK4kakA8jFg==", null, false, "101c3fd2-d97e-4e69-bf9b-02a370040072", false, "admin@localhost.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "System", new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7957), new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7958), "Shoes", "System" },
                    { 2, "System", new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7960), new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7960), "Electronics", "System" },
                    { 3, "System", new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7962), new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7962), "Babies & Kids", "System" },
                    { 4, "System", new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7963), new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7964), "Men's Fashion", "System" },
                    { 5, "System", new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7965), new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7966), "Woman's Fashion", "System" },
                    { 6, "System", new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7967), new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7968), "Watches", "System" },
                    { 7, "System", new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7969), new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7970), "Furniture", "System" },
                    { 8, "System", new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7971), new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7971), "Vehicles", "System" },
                    { 9, "System", new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7973), new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7973), "Sports Equipment", "System" },
                    { 10, "System", new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7974), new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7975), "Pets", "System" },
                    { 11, "System", new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7976), new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7977), "Bags", "System" },
                    { 12, "System", new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7978), new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7979), "Luxury", "System" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "System", new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(8205), new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(8205), "New", "System" },
                    { 2, "System", new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(8207), new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(8207), "Fair", "System" },
                    { 3, "System", new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(8209), new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(8209), "Poor", "System" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "System", new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7737), new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7748), "Shipped", "System" },
                    { 2, "System", new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7750), new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7750), "Delivered", "System" },
                    { 3, "System", new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7752), new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7752), "Canceled", "System" },
                    { 4, "System", new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7753), new DateTime(2024, 2, 3, 21, 31, 57, 626, DateTimeKind.Local).AddTicks(7754), "Pending", "System" }
                });
