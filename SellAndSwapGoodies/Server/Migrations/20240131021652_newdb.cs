    ...
    public partial class newdb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "3781efa7-66dc-47f0-860f-e506d04102e4", 0, 0, "d9b0a53b-8be5-4509-b4a9-c73438536fe4", "admin@localhost.com", false, "Admin", "User", false, null, "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAEPc/UIUzL9BdytjACAVvMaPc6ATgSbMUTRZYRg46L+O/mtC8PRyxSfVhXHhBuMTN+g==", null, false, "86203a05-7550-45dc-8ae4-96eef0383657", false, "admin@localhost.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "System", new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8247), new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8248), "Shoes", "System" },
                    { 2, "System", new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8250), new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8250), "Electronics", "System" },
                    { 3, "System", new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8252), new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8252), "Babies & Kids", "System" },
                    { 4, "System", new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8253), new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8254), "Men's Fashion", "System" },
                    { 5, "System", new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8255), new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8255), "Woman's Fashion", "System" },
                    { 6, "System", new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8256), new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8256), "Watches", "System" },
                    { 7, "System", new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8257), new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8258), "Furniture", "System" },
                    { 8, "System", new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8259), new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8259), "Vehicles", "System" },
                    { 9, "System", new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8260), new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8260), "Sports Equipment", "System" },
                    { 10, "System", new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8261), new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8262), "Pets", "System" },
                    { 11, "System", new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8263), new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8264), "Bags", "System" },
                    { 12, "System", new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8265), new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8265), "Luxury", "System" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "System", new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8421), new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8422), "New", "System" },
                    { 2, "System", new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8423), new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8423), "Fair", "System" },
                    { 3, "System", new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8424), new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8425), "Poor", "System" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "System", new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8065), new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8080), "Shipped", "System" },
                    { 2, "System", new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8082), new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8082), "Delivered", "System" },
                    { 3, "System", new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8084), new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8084), "Canceled", "System" },
                    { 4, "System", new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8085), new DateTime(2024, 1, 31, 10, 16, 52, 217, DateTimeKind.Local).AddTicks(8085), "Pending", "System" }
                });
