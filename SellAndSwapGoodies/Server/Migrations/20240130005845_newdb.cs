    ...
    public partial class newdb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "3781efa7-66dc-47f0-860f-e506d04102e4", 0, 0, "783d98e6-acbb-4e90-8d9b-0a0773da22ff", "admin@localhost.com", false, "Admin", "User", false, null, "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAEDIwlc7y/5XLsIEV7gXnK2sZjCB/9t3Fad8gJkLyJv8XGfpRuFVLXzm1NZHaXEbt7w==", null, false, "d5d04f42-3ca6-4ab1-9b12-fa5bdda8ba11", false, "admin@localhost.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "System", new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(6336), new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(6338), "Shoes", "System" },
                    { 2, "System", new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(6341), new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(6342), "Electronics", "System" },
                    { 3, "System", new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(6344), new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(6345), "Babies & Kids", "System" },
                    { 4, "System", new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(6347), new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(6348), "Men's Fashion", "System" },
                    { 5, "System", new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(6500), new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(6501), "Woman's Fashion", "System" },
                    { 6, "System", new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(6503), new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(6504), "Watches", "System" },
                    { 7, "System", new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(6506), new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(6507), "Furniture", "System" },
                    { 8, "System", new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(6508), new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(6509), "Vehicles", "System" },
                    { 9, "System", new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(6511), new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(6512), "Sports Equipment", "System" },
                    { 10, "System", new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(6514), new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(6514), "Pets", "System" },
                    { 11, "System", new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(6517), new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(6540), "Bags", "System" },
                    { 12, "System", new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(6564), new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(6565), "Luxury", "System" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "System", new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(7644), new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(7651), "New", "System" },
                    { 2, "System", new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(7655), new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(7656), "Fair", "System" },
                    { 3, "System", new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(7658), new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(7658), "Poor", "System" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "System", new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(5795), new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(5815), "Shipped", "System" },
                    { 2, "System", new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(5819), new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(5820), "Delivered", "System" },
                    { 3, "System", new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(5823), new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(5824), "Canceled", "System" },
                    { 4, "System", new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(5826), new DateTime(2024, 1, 30, 8, 58, 45, 93, DateTimeKind.Local).AddTicks(5828), "Pending", "System" }
                });
