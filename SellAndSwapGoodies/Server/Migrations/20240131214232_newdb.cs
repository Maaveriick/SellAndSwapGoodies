    ...
    public partial class newdb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "3781efa7-66dc-47f0-860f-e506d04102e4", 0, 0, "bbc59afc-5f91-4781-8698-6bd21cf27be0", "admin@localhost.com", false, "Admin", "User", false, null, "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAEAymDaPo8Ds30Cbh4/AzuDOY40CIFcT3o5nGb/N2exLyCbqxcdrfZCUKByjz9hymLg==", null, false, "00aa978b-c467-455f-93cb-812dcbd72e30", false, "admin@localhost.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "System", new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1137), new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1137), "Shoes", "System" },
                    { 2, "System", new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1139), new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1139), "Electronics", "System" },
                    { 3, "System", new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1140), new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1141), "Babies & Kids", "System" },
                    { 4, "System", new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1142), new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1142), "Men's Fashion", "System" },
                    { 5, "System", new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1144), new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1144), "Woman's Fashion", "System" },
                    { 6, "System", new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1145), new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1146), "Watches", "System" },
                    { 7, "System", new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1147), new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1148), "Furniture", "System" },
                    { 8, "System", new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1149), new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1150), "Vehicles", "System" },
                    { 9, "System", new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1151), new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1151), "Sports Equipment", "System" },
                    { 10, "System", new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1153), new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1153), "Pets", "System" },
                    { 11, "System", new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1155), new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1155), "Bags", "System" },
                    { 12, "System", new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1156), new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1157), "Luxury", "System" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "System", new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1374), new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1375), "New", "System" },
                    { 2, "System", new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1376), new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1377), "Fair", "System" },
                    { 3, "System", new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1378), new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(1379), "Poor", "System" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "System", new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(908), new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(919), "Shipped", "System" },
                    { 2, "System", new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(920), new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(921), "Delivered", "System" },
                    { 3, "System", new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(922), new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(923), "Canceled", "System" },
                    { 4, "System", new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(924), new DateTime(2024, 2, 1, 5, 42, 32, 413, DateTimeKind.Local).AddTicks(925), "Pending", "System" }
                });
