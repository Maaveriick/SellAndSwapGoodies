...
builder.Services.AddHttpClient("SellAndSwapGoodies.ServerAPI", (sp,client) => { client.BaseAddress = new Uri(builder.HostEnvironment.BaseAddress); client.EnableIntercept(sp);})
